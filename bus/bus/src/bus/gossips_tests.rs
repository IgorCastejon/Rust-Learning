...
fn given_two_drivers_and_same_route_middle_when_check_gossips_then_should_return_2() {
    let routes = vec![vec![1, 2], vec![4, 2]];
    let result = get_time_when_all_drivers_know_all_secrets(Routes::from_vec(routes));
